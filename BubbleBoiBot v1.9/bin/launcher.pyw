...
class Ui_BubbleBoiLauncher(object):
    ...
    def retranslateUi(self, BubbleBoiLauncher):
        ...
        BubbleBoiLauncher.setWindowTitle(_translate("BubbleBoiLauncher", "BubbleBoiBot v1.9 - Launcher"))
        ...
        self.title_label.setText(_translate("BubbleBoiLauncher", "BubbleBoiBot v1.9"))
